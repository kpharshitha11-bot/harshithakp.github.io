![Portfolio Screenshot](interface.png)
...
Or access the online demo here: [Live Demo](https://github.com/kpharshitha11-bot)
...
1. **Clone this repository**
   ```bash
   git clone https://github.com/kpharshitha11-bot
   cd HKP
...
- Email: kpharshitha11@gmail.com   
- Location: Mangalore, India
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/harshitha-kp/)  
- GitHub: [GitHub]( https://github.com/kpharshitha11-bot)  

---

Made with ❤️ by **Harshitha K P**
